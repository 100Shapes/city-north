...
$(function() {  
  ...
  $(".form-emailer").submit(function(e) {
    console.log("trying...");
    if (($('#Field14').val().length>0)&&($('#Field15').val().length>0)&&($('#Field16').val().length>0)){
      console.log ('good');
      $.ajax({  
        type: "POST",  
        url: "http://100shapes.wufoo.com/forms/q11hfxky107rt5l/#public",
        data: $("#form1").serialize(),  
        success: function(data, textStatus, jqXHR) {  
          console.log(data, textStatus, jqXHR);
